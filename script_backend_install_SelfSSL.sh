...
commonName=$IPNUM
organizationalUnitName= whatever.com
...
echo -e "\e[96mCLONING BITBUCKET REPO (will ask for your bitbucket password)\e[39m"
git clone $REPO
# SYSTEM WILL ASK THE USER PASSWORD
sleep 5
#---------------------------------------------------------------------------
#
#---------------------------------------------------------------------------
#CREATE LOG FILE
cd
cd ../var/www/$FOLDER # move to the code folder
pwd
mkdir logs
...
cd  # returns to root
pm2 start ../var/www/$FOLDER/app.js # start app
